use outto_core::config::Privileges;
...
pub fn needs_elevation(privileges: &Privileges) -> bool {
    match privileges {
        Privileges::Admin => !is_elevated(),
        Privileges::User => false,
        Privileges::Auto => false,
    }
}
